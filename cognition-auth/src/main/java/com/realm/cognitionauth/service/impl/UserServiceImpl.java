...
import com.realm.cognitionauth.dao.*;
import com.realm.cognitionauth.entity.*;
import com.realm.cognitionauth.service.DeptService;
import com.realm.cognitionauth.service.UserService;
import com.realm.cognitionauth.vo.UserVo;
...
//    private BootdoConfig bootdoConfig;
    ...
    public Tree<Dept> getTree() {
        ...
        for (User user : users) {
            ...
            Tree<Dept> tree = BuildTree.setTrees(user.getId().toString(), user.getDeptId().toString(), user.getLoginName(), state);
            trees.add(tree);
        }
